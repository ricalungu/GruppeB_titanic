...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{Altersverteilung.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{Überlebensrate_nach_Geschlecht.png}
\caption{Überlebensrate nach Geschlecht}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{Überlebensrate_nach_Passagierklasse.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{Ticketpreise_Überlebensstatus.png}
